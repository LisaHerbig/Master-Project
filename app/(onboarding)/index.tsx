        ...
        <View style={styles.centered}>
          <View style={styles.card}>
            ...
            <View style={styles.headingGroup}>
              <H3>WILLKOMMEN</H3>
              <S2>IN EINER WELT VON MORGEN</S2>
            </View>
            <Text style={styles.body}>
              Tauche tiefer in die Welten von Stefan, Emilia, Familie Schneider, Johanna und
              Benedikt ein. Erlebe wie die Geschichten und die Realität miteinander verwoben sind.
            </Text>
